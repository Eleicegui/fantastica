...
( function( window ) {
    ...
    FForm.prototype._addControls = function() {
        ...
        // this._showCtrl( this.ctrlContinue );  // para que al principio esconda el Continuar
    ...
    FForm.prototype._initEvents = function() {
        ...
        document.addEventListener( "keydown", function( ev ) {
            if ( !self.isLastStep && ev.target.tagName.toLowerCase() !== "textarea" ) {
                ...
                if ( keyCode === 13 ) {
                    if ( self.fields[self.current].hasAttribute( "data-input-trigger" ) ) {
                        return;
                    }
                    ev.preventDefault();
                    self._nextField();
    ...
    FForm.prototype._nextField = function( backto ) {
        ...
        if (!this.isLastStep) {
            ...
            if ( this.fields[index].hasAttribute( "data-input-trigger" ) ) {
    ...
    FForm.prototype._showError = function( err ) {
        ...
        switch( err ) {
        case "NOVAL" :
            message = "Por favor rellene el campo antes de continuar";
            break;
        case "INVALIDEMAIL" :
            message = "Por favor rellene con una dirección de email válida";
            break;
        // ...
        }
